...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1012&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-breakdown-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-breakdown` can be installed with `conda`:
...
```
mamba install r-breakdown
```

It is possible to list all of the versions of `r-breakdown` available on your platform with `conda`:
...
```
mamba search r-breakdown --channel conda-forge
```
...
mamba repoquery search r-breakdown --channel conda-forge

# List packages depending on `r-breakdown`:
mamba repoquery whoneeds r-breakdown --channel conda-forge

# List dependencies of `r-breakdown`:
mamba repoquery depends r-breakdown --channel conda-forge
```
